...
var h5, red, green, paraText, score;


function spawnBullets() {
    if (World.frameCount % Math.round(random(100, 200)) == 0) {
        bullets = createSprite(Math.round(random(width - 100, width - 50), 40, 10, 10));
...
function gamestate(state) {
    if (state == "Serve") {
        ...
        h5 = createElement(
            'p', 'Hit the coins and tech! If you get 5 tech, you will get 1 coins! <br> If you get 10 coins, you will get 2 more lives. <br> You will lose one life, if you get hit by a bullet.'
        );
        ...
        text("Press 'Start Button' to Start.", width / 60, height / 8.0)
